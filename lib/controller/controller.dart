...
//////////////////////////////REGISTRATION ///////////////////////////
          ...
          if (regResmapp.containsValue('Phone limit exceeded')) {
            ...
            if (regResmapp["SERIES"] == null || regResmapp["SERIES"].isEmpty) {
              ...
              else 
              {
                ...
                notifyListeners();
                CustomSnackbar snackbar = CustomSnackbar();
                snackbar.showSnackbar(context, "Error Connecting Database 2", "");
  ...
  initSecondaryDb(BuildContext context) async {
    ...
    debugPrint("seconderyDB-----IP : $ip, PORT : $port, DB: $db, USR : $un, PWD : $pw");
    try {
      await SqlConn.connect(
        ip: ip!,
        port: port!,
...
/////////////////////////////////MASTER DATA/////////////////////////
  getMasterData(
    ...
    if (con == 1) {
      ...
      notifyListeners();
      CustomSnackbar snackbar = CustomSnackbar();
      snackbar.showSnackbar(context, "Connection Error,Error downloading Master Details", "");
      print("NOT connected 2nd");
    }
  }
...
////////////////////////////////////////GETMASTER ALL////////////////////////////
  getMasterDataALL(BuildContext context, int index, String page) async {
    ...
    if (con == 1) {
      ...
      notifyListeners();
      CustomSnackbar snackbar = CustomSnackbar();
      snackbar.showSnackbar(context, "Error Connecting Database..Failed to download all Master", "");
      print("NOT connected 2nd");
    }
  }
...
/////////////////////////////////////////////////////////////////
  ...
  uploadOrdersDataSQL(
    ...
    if (con == 1) {
      ...
      notifyListeners();
      CustomSnackbar snackbar = CustomSnackbar();
      snackbar.showSnackbar(context, "Error Connecting Database,failed to upload order", "");
      print("NOT connected 2nd");
    }
  }
  ////////////////////////upload salesdata////////////////////////////////////////
  ...
  uploadSalesDatasql(
    ...
    if (con == 1) {
      ...
      notifyListeners();
      CustomSnackbar snackbar = CustomSnackbar();
      snackbar.showSnackbar(context, "Error Connecting Database,failed to upload sales", "");
      print("NOT connected 2nd");
    }
  }
  ...
  uploadCollectionDataSQL(BuildContext context, int? index, String page) async {
    ...
    else 
    {
      ...
      notifyListeners();
      CustomSnackbar snackbar = CustomSnackbar();
      snackbar.showSnackbar(context, "Error Connecting Database,failed to upload collection", "");
      print("NOT connected 2nd");
    }
  }
